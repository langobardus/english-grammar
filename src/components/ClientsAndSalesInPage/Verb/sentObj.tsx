...
const isPluralPronoun = (pron: TPronoun) =>
	pron === PRONOUN_YUO || pron === PRONOUN_WE || pron === PRONOUN_THEY;
...
const PastSimpleAffirmative: FC<{ pron: TPronoun }> = ({ pron }) => (
	<div>
		...
		<p>
			{blue(pron)} <b>went</b> home last night. {tag('go - went - gone')}
		</p>
	</div>
);
	...
	Past: {
		Simple: {
			'+ Affirmative sentence': {
				...
				You: <PastSimpleAffirmative pron={PRONOUN_YUO} />,
			...
			'- Negative sentence': {
				...
				You: <PastSimpleNegative pron={PRONOUN_YUO} />,
			...
			'? Questions sentence': {
				...
				You: <PastSimpleQuestion pron={PRONOUN_YUO} />,
		...
		'To be': {
			'+ Affirmative sentence': {
				...
				You: <PastToBeAffirmative pron={PRONOUN_YUO} />,
			...
			'- Negative sentence': {
				...
				You: <PastToBeNegative pron={PRONOUN_YUO} />,
			...
			'? Questions sentence': {
				...
				You: <PastToBeQuestion pron={PRONOUN_YUO} />,
	...
	Present: {
		Simple: {
			'+ Affirmative sentence': {
				...
				You: <PresentSimpleAffirmative pron={PRONOUN_YUO} />,
			...
			'- Negative sentence': {
				...
				You: <PresentSimpleNegative pron={PRONOUN_YUO} />,
			...
			'? Questions sentence': {
				...
				You: <PresentSimpleQuestion pron={PRONOUN_YUO} />,
		...
		'To be': {
			'+ Affirmative sentence': {
				...
				You: <PresentToBeAffirmative pron={PRONOUN_YUO} />,
			...
			'- Negative sentence': {
				...
				You: <PresentToBeNegative pron={PRONOUN_YUO} />,
			...
			'? Questions sentence': {
				...
				You: <PresentToBeQuestion pron={PRONOUN_YUO} />,
